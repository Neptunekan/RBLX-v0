...
-- local LeftGroupBox = Window.Tabs.Rollback:AddLeftGroupbox('Universal Rollback')
...
LeftGroupBox:AddToggle('MyToggle', {
    ...
    Tooltip = 'Enable the selected method.', -- Information shown when you hover over the toggle
